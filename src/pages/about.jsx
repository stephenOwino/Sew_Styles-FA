		...
		<div className='bg-gray-50 min-h-screen p-4 sm:p-8'>
			<div className='max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 sm:p-8'>
				...
				<p className='text-base sm:text-lg text-gray-700 leading-relaxed mb-4'>
					Founded by a group of passionate artisans, SewStyle was born from the
					desire to bridge the gap between talented tailors and individuals
					seeking custom clothing. Our platform is dedicated to celebrating the
					artistry of tailoring, ensuring that everyone can find their perfect
					fit and express their unique style.
				</p>
